...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, syncStatus = 'unconfigured', onSyncClick }) => {
  ...
  return (
    ...
    >
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex-shrink-0 z-30 shadow-sm flex items-center justify-between">
      ...
      <nav className="flex-shrink-0 bg-white border-t border-slate-200 w-full z-40 pb-safe">
